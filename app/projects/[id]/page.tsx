...
const projects = [
    {
      ...
      imageGroup1: [
        ...
        { src: "/mini image cs 1.png", caption: "" },
        { src: "/mini image cs bottom 1.png", caption: "" },
      ],
      imageGroup2: [
        { src: "/mini image CS middle 1.jpg", caption: "" },
        { src: "/cs 1 1.jpg", caption: "" },
        { src: "/cs 2 1.jpg", caption: "" },
      ],
      imageGroup3: [
        { src: "/cs 3 1.jpg", caption: "" },
        { src: "/cs 4 1.png", caption: "" },
        { src: "/cs 5 1.png", caption: "" },
      ],
    ...
    },
    {
      ...
      imageGroup1: [
        { src: "/MAIN IMAGE AE.jpg", caption: "" },
        { src: "/mini image AE top.jpg", caption: "" },
        { src: "/mini image AE middle.jpg", caption: "" },
      ],
      imageGroup2: [
        { src: "/AE 5.jpg", caption: "" },
        { src: "/AE 1.jpg", caption: "" },
        { src: "/AE-2.jpg", caption: "" },
      ],
      imageGroup3: [
        { src: "/AE 3.jpg", caption: "" },
        { src: "/AE 4.jpg", caption: "" },
      ...
      description5: "Ashleaf Elementary evokes the feeling of a close-knit school community by offering small scale, unique, learning pods and exploratory spaces that all connect back to the place where people in any small town gather- The Main Street",
    ...
    },
    {
      ...
      imageGroup1: [
        { src: "/MAIN IMAGE AA (1).jpg", caption: "" },
