...
const projects = [
    ...
    },
    {
      ...
      description5: "An outdoor ampether is a gathering space that brings the community together for performances, presentations, and events. Designed to inspire creativity and collaboration, it serves as a dynamic learning environment where students can showcase their talents and engage with the community in meaningful ways. he outdoor cafeteria serves as a vibrant hub for community engagement, hosting school events, family gatherings, and local celebrations. This space fosters stronger connections between students during school hours, and the community during all times of the year. ",
